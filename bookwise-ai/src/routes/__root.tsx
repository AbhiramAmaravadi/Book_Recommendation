    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          That shelf doesn't exist — but plenty of others do.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Personalized book recommendations powered by intelligent AI and your reading taste." },
      { name: "author", content: "BookWise AI" },
      { property: "og:title", content: "BookWise AI" },
      { property: "og:description", content: "Personalized book recommendations powered by intelligent AI and your reading taste." },
